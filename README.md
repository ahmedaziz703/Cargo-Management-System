...
## 🧩 بنية النظام
📁 acms │ ├── index.php                 ← الصفحة الرئيسية لتتبع الشحنات ├── track.php                 ← صفحة عرض حالة الشحنة │ ├── admin/                   ← لوحة التحكم │   ├── login.php            ← صفحة تسجيل الدخول │   ├── dashboard.php        ← الصفحة الرئيسية للمشرف │   └── shipments.php        ← إدارة معلومات الشحنات │ ├── includes/ │   └── db.php               ← إعداد الاتصال بقاعدة البيانات │ ├── assets/ │   ├── css/                 ← ملفات التنسيق │   ├── js/                  ← ملفات JavaScript │   └── images/              ← الصور المستخدمة في الواجهة
